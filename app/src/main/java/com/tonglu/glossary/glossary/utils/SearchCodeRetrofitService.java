 ...
 */
public class SearchCodeRetrofitService {
    ...
    public static final String URL = "https://searchcode.com/";//查询词汇使用情况


    protected SearchCodeRetrofitService() {
    ...
    private volatile static SearchCodeRetrofitService instance = null;

    private Retrofit retrofit;

    public static SearchCodeRetrofitService getInstance() {
        if (instance == null) {
            synchronized (SearchCodeRetrofitService.class) {
                if (instance == null) {
                    instance = new SearchCodeRetrofitService();
                }
            }
        }
        return instance;
